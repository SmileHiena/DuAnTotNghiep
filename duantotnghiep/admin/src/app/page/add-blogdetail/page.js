...
const AddBlogForm = () => {
  ...
  <button
    type="submit"
    className="w-full py-2 mt-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold rounded-full shadow-md transition duration-300 ease-in-out"
  >
    Thêm Blog
  </button>
</form>
