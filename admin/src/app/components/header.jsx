        ...
        <>
            ...
            <aside className="app-sidebar">
                ...
                <ul className="app-menu">
                    ...
                    <li><Link className="app-menu__item" href="#"><i className='app-menu__icon bx bx-user-voice'></i><span className="app-menu__label">Quản lý khách hàng</span></Link></li>
                    <li><Link className="app-menu__item" href="table-data-product.html"><i className='app-menu__icon bx bx-purchase-tag-alt'></i><span className="app-menu__label">Quản lý sản phẩm</span></Link></li>
                    <li><Link className="app-menu__item" href="table-data-oder.html"><i className='app-menu__icon bx bx-task'></i><span className="app-menu__label">Quản lý đơn hàng</span></Link></li>
                    <li><Link className="app-menu__item" href="table-data-banned.html"><i className='app-menu__icon bx bx-run'></i><span className="app-menu__label">Quản lý nội bộ</span></Link></li>
                    <li><Link className="app-menu__item" href="table-data-money.html"><i className='app-menu__icon bx bx-dollar'></i><span className="app-menu__label">Bảng kê lương</span></Link></li>
                    ...
                    <li><Link className="app-menu__item" href="page-calendar.html"><i className='app-menu__icon bx bx-calendar-check'></i><span className="app-menu__label">Lịch công tác</span></Link></li>
