      ...
      <div className="max-w-[1410px] mx-auto flex items-center justify-between flex-wrap">
        ...
        <nav className="ml-8 w-full xl:w-auto hidden xl:block">
          <ul className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:space-x-6 items-center justify-center" style={{ marginBottom: '0px' }}>
            ...
            <li>
              <Link href="/page/danhsach" className="text-[#FFFFFF] no-underline hover:text-[#F5CF49] transition-colors duration-300">
                Danh sách phim
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/page/lichchieu" className="text-[#FFFFFF] no-underline hover:text-[#F5CF49] transition-colors duration-300">
                Lịch chiếu
              </Link>
            </li>
            <li>
              <a href="/page/sukien" className="text-[#FFFFFF] no-underline hover:text-[#F5CF49] transition-colors duration-300">
                Sự kiện
              </a>
            </li>
            <li>
        ...
        <div className="ml-8">
          <Link href="/page/login">
            <button className="hidden sm:inline-block border-2 border-[#F5CF49] bg-[#212529] text-[#FFFFFF]  w-[117px] h-[30px] rounded hover:bg-[#F5CF49] hover:text-[#000000] hover:font-bold transition uppercase text-[14px]">
              Đăng Nhập
            </button>
          </Link>
