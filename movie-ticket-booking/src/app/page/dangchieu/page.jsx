...
export default function DanhSachPhimDangChieu() {
  ...
  const fetchMovies = async () => {
    try {
      const res = await fetch("http://localhost:3000/dangchieu", { // URL API cho phim đang chiếu
        cache: "no-store",
      });
  ...
  if (loading)
    return <div className="text-center text-white">Đang tải phim...</div>;
  ...
  return (
    <section className="bg-[rgba(0,0,0,0.4)]">
      <div className="container mx-auto px-4 py-8 flex flex-col max-w-[1410px] w-full">
        <h1 className="text-center text-[30px] md:text-[40px] font-bold mt-8 mb-8 text-[#F5CF49]">
          PHIM ĐANG CHIẾU
        </h1>
        ...
        <div className="flex justify-between mb-4">
          ...
          <div className="flex items-center">
            ...
            <select
              ...
              className="bg-white border border-gray-300 text-black rounded py-2 px-4"
            >
              <option value="all">Tất cả</option>
