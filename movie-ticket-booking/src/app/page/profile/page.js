...
import '../../../../public/styles/profile.css'; // Assuming you have a Profile.css for the styles
        ...
        <div className="profile-container">
            <div className="frofile-coutumer">
                ...
                <div className="profile-picture">
                    <img src="/images/phim/cong-tu-bac-lieu.jpg" alt="Profile" />
                    ...
                    <div className="customer-info">
                        <div className="info-coutumer">
                            ...
                            <div className="pro-btn">
                               <Link  href="./editprofile"><button className="edit-button">Sửa thông tin</button></Link> 
                        ...
                        <table className="order-table">
                            ...
                            <tbody>
                                <tr className='info-oder'>
                                    ...
                                    <th>Đã duyệt</th>
                                    <th className='detail-oder'> <p>xem chi tiết</p></th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
