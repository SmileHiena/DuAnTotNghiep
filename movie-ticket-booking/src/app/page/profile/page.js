        ...
        <div className="flex flex-col md:flex-row justify-between mt-5 mb-8 gap-4">
          <div className="w-full md:w-1/3 h-auto p-6 bg-gray-700">
            ...
            <div className="flex items-center ">
              ...
              />
              <p className="text-white" style={{ marginTop: "20px" }}>
                <strong>SĐT:</strong> {accountInfo.SDT}
              </p>
            </div>
            <div className="flex items-center ">
              <FontAwesomeIcon
            ...
            <div className="flex items-center ">
              ...
              <p className="text-white" style={{ marginTop: "20px" }}>
                <strong>Địa chỉ:</strong> {accountInfo.DiaChi}
              </p>
            </div>
                ...
                <tr className="bg-gray-700">
                  ...
                  <td className="text-center px-2 py-2">
                    <button
                      ...
                      className="bg-[#F5CF49] text-[#000000] rounded px-2"
                    >
                      chi tiết
                    </button>
                  </td>
        ...
        {showOrderDetails && (
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div className="bg-gray-700 p-6 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-center text-[#F5CF49]">
                Thông Tin Đơn Hàng
              </h2>
              <p>
                <strong>Mã Đơn Hàng:</strong> ORD-20241015-12345
              </p>
              <p>
                <strong>Ngày Đặt Hàng:</strong> 15/10/2024
              </p>
              <h3 className="text-xl font-bold mt-2 text-[#F5CF49]">
                Thông Tin Vé Xem Phim
              </h3>
              <p>
                <strong>Tên Phim:</strong> Avengers: Endgame
              </p>
              <p>
                <strong>Thời Gian Chiếu:</strong> 15/10/2024 - 19:00
              </p>
              <p>
                <strong>Địa Điểm Chiếu:</strong> Ticket Quận 12, 271 Nguyễn
                Trãi, Phường Nguyễn Cư Trinh, Quận 1, TP Hồ Chí Minh
              </p>
              <p>
                <strong>Loại Vé:</strong> Vé VIP 3D
              </p>
              <p>
                <strong>Số Ghế:</strong> A5, A6
              </p>
              <p>
                <strong>Giá Vé:</strong> 100.000 VNĐ
              </p>
              <p>
                <strong>Tổng Tiền:</strong> 200.000 VNĐ
              </p>
              <p>
                <strong>Mã Vé:</strong> #VQ123456
              </p>
              <button
                onClick={toggleOrderDetails}
                className="mt-4 bg-[#F5CF49] text-[#000000] py-2 px-4 rounded-lg"
              >
                Đóng
              </button>
            </div>
