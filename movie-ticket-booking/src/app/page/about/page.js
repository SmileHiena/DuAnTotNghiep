...
const About = () => {
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#212529' }}>
      <div className="max-w-4xl w-full p-8 rounded-lg shadow-lg transition-transform transform hover:scale-105 duration-300" style={{ backgroundColor: 'rgba(0, 0, 0, 0.35)' }}>
