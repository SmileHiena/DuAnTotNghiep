...
const EventPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}> {/* Nền ngoài 45% trong suốt */}
          ...
          {Sukien.map((event) => (
            <div key={event.id} className="mb-20 rounded-lg shadow-md overflow-hidden flex h-[450px]" style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)' }}> {/* Nền trong 75% trong suốt và chiều cao cố định */}
              ...
              <div className="p-14  w-1/2 flex flex-col justify-between"> 
                ...
                {/* Nút Đặt Vé Ngay */}
                <button
                  className="mt-4 bg-[#F5CF49] text-black py-2 px-4 rounded hover:bg-[#e0b52e] transition duration-200"
