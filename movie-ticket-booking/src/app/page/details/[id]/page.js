          ...
          <div className="flex flex-col md:flex-row items-start gap-10 mt-8">
            ...
            <div className="md:w-[65%] flex flex-col">
              ...
              <div className="flex mt-7 space-x-2">
                ...
                <Link href={`/page/datve/${movie.id}`}><button className="text-[20px] bg-[#F5CF49] text-[#000000] font-semibold rounded hover:bg-yellow-300" style={{ width: "150px", height: "40px" }}>Đặt vé</button></Link>
              </div>
            </div>
          </div>
          {isVisible && (
